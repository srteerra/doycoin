                    ...
                    <b-col class="my-auto text-center">
                      <div>
                        <div v-if="currentStep==1" border-variant="light" class="p-0">
                          ...
                          <div class="px-0 pb-5 amountSelection">
                            <div class="amountSelection-item">
                              <input type="radio" id="1Tree" v-model="amountSelected" name="amountSelection" value="1" checked/>
                              <label for="1Tree">1 tree</label>
                            </div>
                            <div class="amountSelection-item">
                              <input type="radio" id="15Trees" v-model="amountSelected" name="amountSelection" value="15"/>
                              <label for="15Trees">15 trees</label>
                            </div>
                            <div class="amountSelection-item">
                              <input type="radio" id="50Trees" v-model="amountSelected" name="amountSelection" value="50"/>
                              <label for="50Trees">50 trees</label>
                            </div>
                            <div class="amountSelection-item">
                              <input type="radio" id="100Trees" v-model="amountSelected" name="amountSelection" value="100"/>
                          ...
                          <b-form-group id="amountSelectedGroup" class="text-dark font-weight-bold">
                            <b-form-input id="customAmountInput" v-model="amountSelectedCustom" type="number" class="w-100 py-2 px-3 mb-3 DonationInput" placeholder="Enter your amount..." required></b-form-input>
                          </b-form-group>
                        ...
                        <div v-if="currentStep==2" border-variant="light" class="px-0">
                          ...
                          <div class="mb-2">
                            <b-button id="nextStepButton" block class="py-2" variant="success" @click="exportDonatorData({name: NameInput, email:EmailInput, message:MessageInput})">Next</b-button>
                          </div>
                          <div>

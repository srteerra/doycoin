<template>
  <footer class="py-5">
      <b-container class="py-5">
          <b-row class="p-0">
              <b-col cols="12" md="6" lg="3" class="d-flex justify-content-center justify-content-lg-start text-center text-lg-left">
              ...
              <b-col cols="12" md="6" lg="3" class="d-flex justify-content-center justify-content-lg-start text-center text-lg-left">
                <ul class="text-dark p-0">
                  ...
                  <li class="py-2">
                    <router-link to="/how">Terms and conditions</router-link>
                  </li>
                </ul>
              </b-col>
              <b-col cols="10" md="12" lg="6" class="pt-5 pt-lg-0 mx-auto">
                <b-row class="d-flex justify-content-center justify-content-lg-end text-center text-lg-left px-3 px-md-0">
                  <ul class="text-dark p-0">
                    <li class="py-2 font-weight-bold">Receive news and giveaways</li>
                    <li class="py-2">
                      <div>
